...
/**
 * Append-only audit + idempotency journal for GME's Nepal prepaid float. One row per
 * OPENING / CREDIT / DEBIT applied to {@link GmeSchemeBalanceEntity}. Maps
 * {@code gme_scheme_balance_entry} (V001). The unique {@code (scheme_code, entry_type, txn_ref)}
