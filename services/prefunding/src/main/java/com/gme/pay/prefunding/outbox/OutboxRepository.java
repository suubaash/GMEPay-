 ...
 *
 * <p>{@link #findUnpublished(Pageable)} returns the oldest unpublished rows first (FIFO by
 * id), matching enqueue order. The {@link Pageable} cap stops a backlog from overwhelming a
 * single publisher tick.
 */
