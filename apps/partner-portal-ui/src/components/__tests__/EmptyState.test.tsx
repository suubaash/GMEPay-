...
// next/dynamic returns the imported module's default in tests; mock the
// lottie module so we don't try to mount a real animation in jsdom.
...
describe('EmptyState', () => {
  ...
  it('renders the message when provided', () => {
    render(
      <EmptyState
        title="Nothing here"
        message="Try processing a payment first."
      />
    );
